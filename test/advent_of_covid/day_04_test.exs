defmodule AdventOfCovid.Day04Test do
  use ExUnit.Case

  alias AdventOfCovid.Day04
  alias AdventOfCovid.Day04.Passport
  ...
  test "parse input" do
    assert Day04.parse_input(@example_input) == [
             %Passport{
               birth_year: "1937",
               country_id: "147",
             ...
             %Passport{
               ...
               height: "59in",
               issue_year: "2011",
               passport_id: "166559648"
             }
           ]
  end

  test "example validation1" do
    assert 2 ==
             @example_input
             |> Day04.parse_input()
             |> Enum.count(&Passport.is_valid1?/1)
  end
  ...
  test "part 2" do
    assert 147 ==
             @provided_input
             |> Day04.parse_input()
             |> Enum.count(&(Passport.is_valid1?(&1) and Passport.is_valid2?(&1)))
  end
end
